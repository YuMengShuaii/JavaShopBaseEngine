...
//    [TangramDefaultItemModelFactory registElementType:@"199" className:@"TangramSingleImageElement"];
//    [TangramDefaultItemModelFactory registElementType:@"2" className:@"TangramSingleImageElement"];
//    [TangramDefaultItemModelFactory registElementType:@"10" className:@"TangramSingleImageElement"];
