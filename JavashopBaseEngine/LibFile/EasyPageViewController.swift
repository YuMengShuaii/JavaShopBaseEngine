...
enum EasyPageScrollDirection {
    case left
    case right
}

@objc protocol EasyPageViewControllerDataSource {
    func easy_pageViewController(_:EasyPageViewController,
                               controllerAtIndex index:Int) -> UIViewController!
    
    func easy_numberOfControllers(_:EasyPageViewController) -> Int
}

@objc protocol EasyPageViewControllerDelegate {
    
    // Sent when a gesture-initiated transition begins.
    @objc optional func easy_pageViewController(_ pageViewController: EasyPageViewController,
...
public class EasyPageViewController: UIViewController, UIScrollViewDelegate, NSCacheDelegate {
    weak var delegate:EasyPageViewControllerDelegate?
    weak var dataSource:EasyPageViewControllerDataSource?
    
    fileprivate(set) var scrollView:UIScrollView! = UIScrollView()
    var pageCount:Int {
        get {
            return self.dataSource!.easy_numberOfControllers(self)
        }
    }
    ...
    override public func viewWillAppear(_ animated: Bool) {
        ...
        if self.firstWillAppear {
            //Config init page
            self.easy_pageViewControllerWillShow(self.lastSelectedIndex, toIndex: self.currentPageIndex, animated: false)
            self.delegate?.easy_pageViewController?(self, willLeaveViewController: self.controllerAtIndex(self.lastSelectedIndex), toViewController: self.controllerAtIndex(self.currentPageIndex), animated: false)
    ...
    override public func viewDidAppear(_ animated: Bool) {
        ...
        if self.firstDidAppear {
            ...
            self.easy_pageViewControllerDidShow(self.lastSelectedIndex, toIndex: self.currentPageIndex, finished: true)
            self.delegate?.easy_pageViewController?(self, didLeaveViewController: self.controllerAtIndex(self.lastSelectedIndex), toViewController: self.controllerAtIndex(self.currentPageIndex), finished: true)
    ...
    @objc func showPageAtIndex(_ index:Int,animated:Bool) {
        ...
        if self.scrollView.frame.size.width > 0.0 &&
            ...
            self.easy_pageViewControllerWillShow(self.lastSelectedIndex, toIndex: self.currentPageIndex, animated: animated)
            self.delegate?.easy_pageViewController?(self, willLeaveViewController: self.controllerAtIndex(self.lastSelectedIndex),
        ...
        if self.scrollView.frame.size.width > 0.0 &&
            ...
            let scrollEndAnimation = { () -> Void in
                ...
                self.easy_pageViewControllerDidShow(self.lastSelectedIndex, toIndex: self.currentPageIndex, finished: animated)
                self.delegate?.easy_pageViewController?(self, didLeaveViewController: self.controllerAtIndex(self.lastSelectedIndex),
            ...
            if animated {
                if self.lastSelectedIndex != self.currentPageIndex {
                    ...
                    let direction = (self.lastSelectedIndex < self.currentPageIndex) ? EasyPageScrollDirection.right : EasyPageScrollDirection.left
    ...
    @objc fileprivate func addVisibleViewContorllerWith(_ index:Int) {
        ...
        self.easy_addChildViewController(vc!,
    ...
    {
        return self.dataSource!.easy_pageViewController(self, controllerAtIndex:index);
    }
    ...
    @objc fileprivate func cleanCacheToClean() {
        ...
        for vc in self.childsToClean {
            ...
            vc.easy_removeFromParentViewController()
        }
        ...
        if (obj as AnyObject).isKind(of: UIViewController.self) {
            ...
            if self.childViewControllers.contains(vc) {
                ...
                let AddCacheToCleanIfNeed = { (midIndex:Int) -> Void in
                    ...
                    let leftNeighbour = self.dataSource!.easy_pageViewController(self, controllerAtIndex: leftIndex)
                    let midPage = self.dataSource!.easy_pageViewController(self, controllerAtIndex: midIndex)
                    let rightNeighbour = self.dataSource!.easy_pageViewController(self, controllerAtIndex: rightIndex)
    ...
    public func scrollViewDidScroll(_ scrollView: UIScrollView) {
        ...
        if scrollView.isDragging == true && scrollView == self.scrollView {
                ...
                self.scrollView.isDecelerating == true
            {
                ...
                {
                    self.easy_pageViewControllerWillShow(self.guessToIndex, toIndex: self.currentPageIndex, animated: true)
                    self.delegate?.easy_pageViewController?(self, willTransitonFrom: self.controllerAtIndex(self.guessToIndex),
                                                          toViewController: self.controllerAtIndex(self.currentPageIndex))
    ...
    func updatePageViewAfterTragging(scrollView:UIScrollView) {
        ...
        self.easy_pageViewControllerDidShow(self.guessToIndex, toIndex: self.currentPageIndex, finished:true)
        self.delegate?.easy_pageViewController?(self, didTransitonFrom: self.controllerAtIndex(self.guessToIndex),
                                              toViewController: self.controllerAtIndex(self.currentPageIndex))
    ...
    // Sent when a gesture-initiated transition begins.
    func easy_pageViewControllerWillTransitonFrom(_ fromIndex:Int, toIndex:Int) { }
    
    // Sent when a gesture-initiated transition ends.
    func easy_pageViewControllerDidTransitonFrom(_ fromIndex:Int, toIndex:Int) { }
    
    // Sent when method(func showPageAtIndex(index:Int,animated:Bool)) begin to be called.
    func easy_pageViewControllerWillShow(_ fromIndex:Int, toIndex:Int, animated:Bool) { }
    
    // Sent after method(func showPageAtIndex(index:Int,animated:Bool)) finished.
    func easy_pageViewControllerDidShow(_ fromIndex:Int, toIndex:Int, finished:Bool) { }
}
